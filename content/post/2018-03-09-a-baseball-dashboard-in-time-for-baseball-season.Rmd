...
If we look at tables of the different tenure values, we can calculate the percentage of players that would remain at each cutoff.
...
knitr::kable(matrix(c(
      ...
      '4 yrs', '92%',
      NULL
), ncol = 2, byrow=TRUE, dimnames = list(NULL, c('Cutoff', '% Cutoff'))),
...
Looking at the nominees, it turns out Scott Rolen only played four seasons for the Reds. The goal of this project is to evaluate nominees, so four years would be the necessary cutoff in order for Rolen to be included. If Rolen wasn't part of this class, I'd consider five years but I wouldn't go above five.
