---
title: A Baseball Dashboard in Time for Baseball Season (part one)
author: Eric Book
date: '2018-03-09'
categories:
  - eda
...
tags:
  ...
  - openWARData
  - rvest
slug: a-baseball-dashboard-in-time-for-baseball-season-part-one
draft: no
output:
  blogdown::html_page:
    toc: yes
...
citet(c(citation('rvest'), citation('openWARData'), citation('Lahman')))
