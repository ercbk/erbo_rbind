...
As for the token portion of issue, I haven't looked into it at all. The `twitteR` package is scheduled for a "leisurely deprecation". From my memory of a few articles that used that package, I think there might be some code in there could help. It's just a hunch though. If anyone finds a solution, I'd be very interested.
