---
title: A Baseball Dashboard in Time for Opening Day (part three)
author: Eric Book
date: '2018-03-23'
slug: a-baseball-dashboard-in-time-for-opening-day-part-three
categories:
  - dashboards
  - dataviz
  - sports-analysis
...
citet(c(citation('tidyverse'), citation('shinydashboard'), citation('knitcitations'), citation('DT'), citation('ggpubr'), citation('ggplot2'), citation('ggiraph')))
```
...
In [part one](https://erbo.rbind.io/blog/2018-03-09-a-baseball-dashboard-in-time-for-opening-day-part-one/), we collected the data. In [part two](https://erbo.rbind.io/blog/2018-03-21-a-baseball-dashboard-in-time-for-opening-day-part-two/), we manipulated the data. Now, we get to see the fruits of our labor. You'll need these objects from part two: `display_table`, `jaws_group`, `war_group`, and `war_combo_avg`. If you want to match the colors of the visuals to the desired team, there's [teamcolorcodes.com](https://teamcolorcodes.com) or [codeofcolors.com](www.codeofcolors.com).
