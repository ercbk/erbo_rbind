...
frameWidget(dt, width = "60%", height = 450)
```
...
Due to the side menu of my website, the dashboard will probably appear stacked. Here's a [link](https://erbo.shinyapps.io/jaws4-post/) to the dashboard that should display full-screen.
...
This project combined two loves mine: baseball and  r -- which I really enjoyed. There wasn't any complex modeling but it really challenged me in ways I didn't think it would. The visual design decisions were more difficult than I anticipated, and it also allowed me to level-up in `purrr` and `tidyeval`. Hope you enjoyed it. 
