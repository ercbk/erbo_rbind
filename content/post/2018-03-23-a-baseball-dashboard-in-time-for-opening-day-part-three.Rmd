...
frameWidget(dt, width = "85%", height = 375)
```
...
Due to my website's sidebar, the dashboard may appear a bit scrunched. Here's a [link](https://erbo.shinyapps.io/jaws4-post/) to the dashboard that should display full-screen.
